...
*/
  ...
  */
  ...
  TextView getLabelView() {
    return null; //XL (TextView) getTag(R.id.fab_label);
  }
  ...
  void updateBackground() {
    ...
    LayerDrawable layerDrawable = new LayerDrawable(
        new Drawable[] {
            ViewTool.getDrawable(getContext(),mSize == SIZE_NORMAL ? R.drawable.fab_bg_normal : R.drawable.fab_bg_mini),
  ...
  Drawable getIconDrawable() {
    if (mIconDrawable != null) {
      ...
      return ViewTool.getDrawable(getContext(),mIcon);
    } else {
